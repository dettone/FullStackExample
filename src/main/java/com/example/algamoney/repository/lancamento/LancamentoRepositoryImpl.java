...
public class LancamentoRepositoryImpl implements LancamentoRepositoryQuery {
	...
	public Page<Lancamento> filtrar(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		return new PageImpl<>(query.getResultList(), pageable, totalLancamentoFilter(lancamentoFilter));
	}
	...
	public 	Page<ResumoLancamento> resumir(LancamentoFilter lancamentoFilter, Pageable pageable) {
		...
		// Root e onde e feita a consulta
		Root<Lancamento> root = criteria.from(Lancamento.class);
	...
	private Predicate[] criarRestricoes(LancamentoFilter lancamentoFilter, CriteriaBuilder builder,
		...
		if (!StringUtils.isEmpty(lancamentoFilter.getDescricao())) {
			predicates.add(builder.like(
					// deixar tudo como letra minuscula
					// where descricao like "%asdadasd%
...
//				predicates.add(builder.like(
	...
	private void adicionarRestricoesDePaginacao(TypedQuery<?> query, Pageable pageable) {
		...
		// Essa multiplicacao e pra mostrar qual e o primeiro registro da pagina
	...
	private Long totalLancamentoFilter(LancamentoFilter lancamentoFilter) {
		CriteriaBuilder builder = manager.getCriteriaBuilder();
